...
ind_1nn = np.load('./fcc_256/ind_1nn.npy')
ind_2nn = np.load('./fcc_256/ind_2nn.npy')
ind_3nn = np.load('./fcc_256/ind_3nn.npy')
ind_4nn = np.load('./fcc_256/ind_4nn.npy')

ind_1nn_345 = np.load('./fcc_256/ind_1nn_345.npy')
ind_2nn_345 = np.load('./fcc_256/ind_2nn_345.npy')
ind_3nn_345 = np.load('./fcc_256/ind_3nn_345.npy')
ind_4nn_345 = np.load('./fcc_256/ind_4nn_345.npy')

ind_1nn_34 = np.load('./fcc_256/ind_1nn_34.npy')
ind_2nn_34 = np.load('./fcc_256/ind_2nn_34.npy')
ind_3nn_34 = np.load('./fcc_256/ind_3nn_34.npy')
ind_4nn_34 = np.load('./fcc_256/ind_4nn_34.npy')

ind_1nn_45 = np.load('./fcc_256/ind_1nn_45.npy')
ind_2nn_45 = np.load('./fcc_256/ind_2nn_45.npy')
ind_3nn_45 = np.load('./fcc_256/ind_3nn_45.npy')
ind_4nn_45 = np.load('./fcc_256/ind_4nn_45.npy')

ind_layer_345 = np.load('./fcc_256/ind_l_345.npy')
ind_layer_34 = np.load('./fcc_256/ind_l_34.npy')
ind_layer_45 = np.load('./fcc_256/ind_l_45.npy')
...
class genetic:
    def __init__(self, cr_, mn_, co_, ni_,
        ...
        assert abs(cr_ + mn_ + co_ + ni_ - 1) < 0.001, 'Make sure atomic ratio sums to 1'
...
if __name__ == '__main__':
    ...
    origin_list = np.load(f'./origin_list{int(cr_*100)}{int(mn_*100)}{int(co_*100)}.npy')
    ...
    np.save(f'./origin_list{int(cr_*100)}{int(mn_*100)}{int(co_*100)}.npy', origin_list)
    np.save(f'./fitness_result{int(cr_*100)}{int(mn_*100)}{int(co_*100)}.npy', fitness_)
    np.save(f'./fitness_whole{int(cr_*100)}{int(mn_*100)}{int(co_*100)}.npy', fitness_mean)
